    ...
    <div className="w-full max-w-md">
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-8">
        ...
        <div>
          <label
            htmlFor="name"
            className="block text-xs uppercase tracking-widest font-sans text-on-surface-variant mb-2"
          >
            Skill Name *
          </label>
          <input
            ...
            disabled={isLoading}
            {...register('name')}
            className="w-full px-4 py-3 bg-surface-container border border-surface-container-highest
                       text-on-surface font-sans text-sm placeholder:text-on-surface-variant/40
                       focus:outline-none focus:border-outline transition-colors
                       disabled:opacity-50"
          />
          {errors.name && (
        ...
        <div className="flex items-center gap-3 pt-2">
          <button
            ...
            onClick={handleSkip}
            disabled={isLoading}
            className="px-4 py-3 font-sans text-sm text-on-surface-variant
